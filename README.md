...
1. Create a GitHub Actions workflow in your repository that uses the latest version of this action. For example, `astronomer/deploy-action@v0.16.0`.
...
- name: Deploy to Astro
  uses: astronomer/deploy-action@v0.16.0
  with:
